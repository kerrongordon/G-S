...
function wp_bootstrap_register_sidebars() {
    ...
    register_sidebar(array(
      'id' => 'footer8',
      'name' => 'Our Partners',
      'before_widget' => '<div id="%1$s" class="widget col-xs-6 col-sm-3 col-md-2 %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h2 class="widgettitle">',
      'after_title' => '</h2>',
    ));
...
if( !function_exists( "theme_js" ) ) {  
  function theme_js(){
    ...
    wp_register_script(  'navtop', 
      get_template_directory_uri() . '/library/js/navtop.js', 
      array('jquery'), 
      '1.2' );
...
// get breadcrumbs show were you are on the site
